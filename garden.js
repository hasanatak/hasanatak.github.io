...
function toy(options) {
  ...
  if (apiOption === "x") {
    ...
    if (Array.isArray(systemPrompt)) {
      const randomIndex = Math.floor(Math.random() * userPrompt.length);
...
toy({
  ...
  systemPrompt: ["السلام عليكم يا ابني...دا موقع للقران فيه خواص ذكاء اصطناعي و افكار جديدة تخليك تستمع بقرايه القران",
    "ربنا يكرمك يابني و تتبرع بصدقه للموقع اصل تتوس تعب فيه اوي والله",
    "تعرف ان الحسنه ب 10 و السيئة ب 1... تخيل لو كان بيحاسبنا الواحده بواحدتها كنا رحنا فين"],
  userPrompt: ""
